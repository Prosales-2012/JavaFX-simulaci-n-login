...
import com.pablorosales.controller.ImageController;
...
public class LoginView extends BorderPane {
    ...
    private String RUTA_ESTILOS = "/com/pablorosales/styles/";
    private LoginView() {
        ...
        this.setBorder(new Border(
                ...
                new BorderStroke(Paint.valueOf("#118C7F"), 

                        BorderStrokeStyle.SOLID,

                        new CornerRadii(5), //estilo de línea 

                        new BorderWidths(10))

        ));

        this.setBackground(new Background(new BackgroundFill(Paint.valueOf("#E3DD09"),new CornerRadii(25), Insets.EMPTY)));
